...
//Special Case 2. To sort a reversely sorted array using all the sorting algorithms
public class Project1SpecialCase2 {
	...
	public static void main(String[] args) {
		...
		P1Arr.generateRandomArray(arr1, sizeOfArray);
		System.out.println("Unsorted Array : ");
		P1Arr.printUnsortedArray(arr1);
		System.out.println();
		
		//to sort the array so that it can be tried for all sorting for special cases		
		InPlaceQuickSort IPQS = new InPlaceQuickSort();
		IPQS.sort(arr1, 0, sizeOfArray-1);
		System.out.println("Sorted Array : ");
		IPQS.printInPlaceQuickSortArray(arr1);
		System.out.println();
				
		P1Arr.reverseSortedArray(arr1, arr);
